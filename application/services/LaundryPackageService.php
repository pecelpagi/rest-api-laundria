...
class LaundryPackageService extends RestController {
    ...
    public function create_data() {
        $PARAM_KEY = 'LaundryPackageColumnConstant';
        ...
        $this->laundry_package->insert_data($this);
    }
    ...
    public function update_data() {
        ...
        $this->laundry_package->update_data($this);
    }
    ...
    public function get_all_data($service) {
        ...
        $data = $this->laundry_package->get_all_data($limit, $offset);
    ...
    public function get_total_pages($service) {
        ...
        $total_data = $this->laundry_package->get_total_all_data();
